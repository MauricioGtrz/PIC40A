      ...
      <?php 
        ...
        */
        function hailstoneSequence($n, $iteration) {
          /* Breaks out of recursive function if value is equal to one*/
          if ($n === 1) {?>
          ...
          /* if statement checks to see if number passed in is even or odd*/
          if ($n % 2 === 0) {
        ...
        hailstoneSequence($x, $i); //execute function by passing in the number from url and iterator (starts at zero)
      ?>
    </tbody>
  </table>
</body>
